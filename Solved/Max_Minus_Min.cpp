...
int BSres(int st,int end,vector<int>arr){int res=-1;while(st<=end){int mid=st+(end-st)/2;if(checkerFunction(mid,arr)){ }else{}}return res;}
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
//prefix suffix section 1 based
vector<int> buildPrefix(vector<int>&arr){vector<int>res(arr.size(),0);for(int i=1;i<=arr.size();i++){res[i]=arr[i]+res[i-1];}return res;}
vector<int> buildSuffix(vector<int>&arr){vector<int>res(arr.size()+1,0);for(int i=arr.size()-1;i>=1;i--){res[i]=res[i+1]+arr[i];}return res;}
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
