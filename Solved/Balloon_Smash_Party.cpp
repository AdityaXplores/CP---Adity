...
int BSAns(int st,int end,vector<int>arr){int rs=-1;while(st<=end){int mid=st+(end-st)/2;if(checkerFunction(mid,arr)){ }else{}}return rs;}
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
//prefix suffix section 1 based
vector<int> buildPrefix(vector<int>&arr){vector<int>rs(arr.size(),0);for(int i=1;i<=arr.size();i++){rs[i]=arr[i]+rs[i-1];}return rs;}
vector<int> buildSuffix(vector<int>&arr){vector<int>rs(arr.size()+1,0);for(int i=arr.size()-1;i>=1;i--){rs[i]=rs[i+1]+arr[i];}return rs;}
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
