...
//                                                              “बलिदानं परमं धर्मः”
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
void move_up(int c,int n,int k,vec &a,vec &b,vec &cnt,vec &ops){
    if(b[c]>k) return;
    int nxt=b[c]+1;
    if(nxt<=k && cnt[nxt]==a[nxt]){
        int blocking_course=-1;
        fr(i,1,n){
            if(b[i]==nxt){
                blocking_course=i;
                break;
        ...
        if(blocking_course==-1) return;
        move_up(blocking_course,n,k,a,b,cnt,ops);
    }
    cnt[b[c]]--;
    b[c]++;
    cnt[b[c]]++;
